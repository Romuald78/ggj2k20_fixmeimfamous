...
export class PlayerFactory {
    ...
    public create(initX: number, initY: number, ctrlID: number, teamId: number): Entity {
        ...
        let atlasName: string = teamId == 1 ? 'playerAtlas1' : 'playerAtlas2';
        ...
        if (ctrlID != 0) {
            ...
            playerInput.register("WALK_LEFT", { type: "key", device_num: ctrlID, input_ref: "LEFTH", threshold: -0.2 });
            playerInput.register("WALK_RIGHT", { type: "key", device_num: ctrlID, input_ref: "LEFTH", threshold: 0.2 });
            playerInput.register("WALK_UP", { type: "key", device_num: ctrlID, input_ref: "LEFTV", threshold: -0.2 });
            playerInput.register("WALK_DOWN", { type: "key", device_num: ctrlID, input_ref: "LEFTV", threshold: 0.2 });
        }
