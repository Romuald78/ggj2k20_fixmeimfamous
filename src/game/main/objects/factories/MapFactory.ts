...
import {PlayerLadderIntercation} from "../components/PlayerLadderIntercation";
...
export class MapFactory {
    ...
    public createMap(players:Entity[],liftFactory:LiftFactory):Entity{
        ...
        // Add script for player and ladder interaction
        entity.addComponent(new PlayerLadderIntercation(players,entity));
